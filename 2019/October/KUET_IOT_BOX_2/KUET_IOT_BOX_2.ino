...
int mq_Pin= 0; // Soil Moisture Sensor input at Analog PIN A0
int mq_value= 0;
...
//    // start working...
  ...
  client.publish("mq17101029", String(mq_value).c_str());
  client.publish("flame17101029", String(flame).c_str());
