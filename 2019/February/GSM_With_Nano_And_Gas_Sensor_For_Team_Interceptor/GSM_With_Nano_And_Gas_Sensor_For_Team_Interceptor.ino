...
void loop()
{  
  gasPinData=analogRead(gasPin);
  Serial.println(gasPinData);
  if(gasPinData>=105){
    SendMessage();
  }
...
void SendMessage()
{
  ...
  mySerial.println("AT+CMGS=\"+8801746208374\"\r"); // Replace x with mobile number
  delay(1000);
  mySerial.println("Agun Agun Agun...");// The SMS text you want to send
  delay(100);
